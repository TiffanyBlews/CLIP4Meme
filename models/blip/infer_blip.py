...
def infer_blip(model_name="blip_feature_extractor", model_type="base", data_path="./imgflip_data/msrvtt", image_path="./imgflip_data/images", batch_size=64, device=None):
...
def main():
    ...
    parser.add_argument("--model_name", type=str, default="blip_feature_extractor")
    ...
    metrics = infer_blip(model_name=args.model_name, model_type=args.model_type, data_path=args.data_path, image_path=args.image_path, batch_size=args.batch_size, device=device)
    for k in [1, 5, 10]:
